      ...
      <main className="main">
        {needsSetup && !wallet && (
          <div className="setup-page">
            <div className="setup-card">
              <div className="setup-icon">🔐</div>
              <h2 className="setup-title">Channel Not Initialized</h2>
              <p className="setup-sub">Connect wallet to initialize this SubscribeX channel.</p>
              <button className="btn-connect" onClick={handleConnect}>Connect Wallet</button>
            </div>
          </div>
        )}
